...
var _getDataApiJs = require("./api/getDataApi.js");
var _addDataApiJs = require("./api/addDataApi.js");
var _updateDataApiJs = require("./api/updateDataApi.js");
var _deleteDataApiJs = require("./api/deleteDataApi.js");
...
function renderStudents(students) {
    ...
    const layout = students.map((student)=>`<tr>
            ...
            <td>
                <button data-update-id="${student.id}">\u{41E}\u{43D}\u{43E}\u{432}\u{438}\u{442}\u{438}</button>
                <button data-delete-id="${student.id}">\u{412}\u{438}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{438}</button>
            <td>
        </tr>`).join('');
...
},{"./api/getDataApi.js":"jlZ3Q","./api/addDataApi.js":"48l6c","./api/updateDataApi.js":"e78Nl","./api/deleteDataApi.js":"f8PbZ"}],"jlZ3Q":[function(require,module,exports,__globalThis) {
...
},{}],"48l6c":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=crud-hw-18.31b563d9.js.map
